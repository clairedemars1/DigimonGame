...
PlayerNonExploding::PlayerNonExploding(): TwoWayMultiSprite("player"),
	...
	jKeyUp(false)
	{}
PlayerNonExploding::PlayerNonExploding(const PlayerNonExploding& rhs):
	...
	jKeyUp(false)
	{}
PlayerNonExploding::PlayerNonExploding(const std::string& name):
...
void PlayerNonExploding::notify(std::string event){
...
//~ void PlayerNonExploding::update(Uint32 ticks, const std::array<char, 2> &directions){
void PlayerNonExploding::update(Uint32 ticks){
	std::array<char, 2> directions;
	const Uint8* keystate; 
	
	advanceFrame(ticks);
	
	//~ TwoWayExplodingMultiSprite::update();
