...
class TwoWayMultiSprite : public MultiSprite {
	public:
		...
		//~ void update(Uint32 ticks); // can't change this, b/c it's going to be overwritten by the derived classes for specific sprites (note: I'm surprised I don't need to declare update here, and say that it's also virtual for twowaymultisprite
